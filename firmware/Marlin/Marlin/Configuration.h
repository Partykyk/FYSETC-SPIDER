...
#define CUSTOM_MACHINE_NAME "Chironinator"
 ...
 */
#define Z_MIN_PROBE_PIN PA3 // Pin 32 is the RAMPS default
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -25, -25, -1.95 }
